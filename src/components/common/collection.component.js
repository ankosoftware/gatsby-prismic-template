            ...
            return (
              <div className="d-flex flex-wrap flex-md-nowrap">
                ...
                <div className="mx-0 mx-md-5 mt-3 mt-md-0 features-accordion-body">
                  ...
                  <div>
                    <CustomLink link={item.link} className={`btn-sm ${getLinkClass(item.linkStyle, "link")}`}>
                      {item.linkText}
                    </CustomLink>
                  </div>
                </div>
              ...
              <div className="d-flex flex-wrap flex-md-nowrap mb-5">
                ...
                <div className="ml-0 ml-md-5 feature-list-body">
                  ...
                  <div className="feature-list-btn">
                    <CustomLink link={item.link} className={getLinkClass(item.linkStyle, "link")}>
                      {item.linkText}
                    </CustomLink>
                  </div>
                </div>
            ...
            return (
              <div className="col-12 col-md-4 mb-4">
                <div className="pb-4 shadow block-3-wrapper">
                  <div className="line bg-primary mb-4" />
        ...
        <div className="features-carousel">
          <div id="carouselIndicators" className="carousel slide" data-ride="carousel">
            <ol className="carousel-indicators">
              {items.map((item, index) => {
                return (
                  <li data-target="#carouselIndicators" data-slide-to={index} className={index === 0 ? "active" : ""} />
                )
              })}
            </ol>
